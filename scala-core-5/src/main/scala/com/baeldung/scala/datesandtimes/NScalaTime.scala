...
object NScalaTime extends App{
  ...
  def measureElapsedTimePeriod(processStart:DateTime, processEnd:DateTime): Period ={
  ...
  println(elapsed.toString(PeriodFormat.getDefault))   // Prints "1 hour, 10 minutes and 5 seconds"
}
