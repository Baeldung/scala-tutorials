...
class TodoListController @Inject() (
  ...
  implicit val todoListJson: play.api.libs.json.OFormat[models.TodoListItem] = Json.format[TodoListItem]
  implicit val newTodoListJson: play.api.libs.json.OFormat[models.NewTodoListItem] = Json.format[NewTodoListItem]
