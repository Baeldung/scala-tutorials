...
@Singleton
class AsyncTaskController @Inject()(val controllerComponents: ControllerComponents, val actorSystem: ActorSystem, @Named("async-job-actor") actor: ActorRef)(implicit ec: ExecutionContext) extends BaseController {
