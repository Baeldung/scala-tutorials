...
val elastic4sVersion = "9.3.0"

val sparkCoreDep = "org.apache.spark" %% "spark-core" % sparkVersion
val sparkSqlDep = "org.apache.spark" %% "spark-sql" % sparkVersion

val enumeratumDep = "com.beachape" %% "enumeratum" % "1.9.6"
...
lazy val scala_libraries = (project in file("scala-libraries"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "software.amazon.awssdk" % "sqs" % "2.42.21"
    ),
    Defaults.itSettings
  )
...
lazy val scala_libraries_testing = (project in file("scala-libraries-testing"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "software.amazon.awssdk" % "s3" % "2.42.21"
    ),
    Defaults.itSettings,
...
lazy val scala_libraries_config = (project in file("scala-libraries-config"))
  .settings(
    ...
    libraryDependencies += "is.cir" %% "ciris" % "3.13.0",
    libraryDependencies += "is.cir" %% "ciris-circe" % "3.13.0",
    libraryDependencies += "is.cir" %% "ciris-circe-yaml" % "3.13.0"
  )
