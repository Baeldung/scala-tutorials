...
lazy val scala_core = (project in file("scala-2-modules/scala-core"))
  .settings(
    name := "scala-core",
    libraryDependencies ++=
      Seq(
...
lazy val scala_core_2 = (project in file("scala-2-modules/scala-core-2"))
  .settings(
    name := "scala-core-2",
...
lazy val scala_core_3 = (project in file("scala-2-modules/scala-core-3"))
  .settings(
    name := "scala-core-3",
    libraryDependencies ++= scalaTestDeps,
    libraryDependencies += jUnitInterface,
...
lazy val scala_libraries_4 = (project in file("scala-libraries-4"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.amazonaws" % "aws-java-sdk-s3" % "1.12.425" % IntegrationTest,
