...
class NumericUnitTest extends AnyWordSpec with Matchers {
  "sum" should {
    ...
    "calculate the sum for a list of integers" in {
    ...
    "calculate the sum for a list of doubles" in {
    ...
    "calculate the sum for a list of BigDecimals" in {
      val bigDecimalList =
    ...
    "calculate the sum for a list of Rationals" in {
