...
object TutorialHelper {
  ...
  class Employee(empCode: Int,
    ...
    def isEligibleForSpecialAllowance: Boolean =
      super.isASeniorCitizen && this.workingForYears > 10
  ...
  class BirdLikeEmployee(empCode: Int,
                         name: String,
                         age: Int,
                         placeOfBirth: String,
                         placeOfWork: String,
  ...
  class SuperWomanLikeEmployee(empCode: Int,
                               name: String,
                               age: Int,
                               placeOfBirth: String,
                               placeOfWork: String,
    ...
    override val minWings: Int = 2
    extraWings = 2
    override def flyFor(howLong: Int): Int =
      (minWings * extraWings) * howLong * 10
  }

  class SingerAndFlierEmployee(empCode: Int,
                               name: String,
                               age: Int,
                               placeOfBirth: String,
                               placeOfWork: String,
    ...
    extraWings = 2
    override def requestASong(firstLine: String): String =
      "www.youtube.com/bundleInOfficeLibrary.mp4"
    override def flyFor(howLong: Int): Int =
      (minWings * extraWings) * howLong * 10
  }
}
