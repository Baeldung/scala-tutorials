...
class PatternMatchingUnitTest {
  @Test
  def whenAMammalIsGivenToTheMatchExpression_ThenItsRecognizedAsMammal()
    : Unit = {
    val result = new PatternMatching().caseClassesPatternMatching(
      Mammal("Lion", fromSea = false)
    )
    assertEquals(
      "I'm a Lion, a kind of mammal. Am I from the sea? false",
      result
    )
  }
  ...
  def whenABirdIsGivenToTheMatchExpression_ThenItsRecognizedAsBird(): Unit = {
    val result =
      new PatternMatching().caseClassesPatternMatching(Bird("Pigeon"))
    assertEquals("I'm a Pigeon, a kind of bird", result)
  }

  @Test
  def whenAnUnkownAnimalIsGivenToTheMatchExpression_TheDefaultClauseIsUsed()
    : Unit = {
  ...
  @Test
  def whenTheConstantZeroIsPassed_ThenItMatchesTheCorrespondingPattern()
    : Unit = {
  ...
  @Test
  def whenTheBooleanFalseIsPassed_ThenItMatchesTheCorrespondingPattern()
    : Unit = {
  ...
  @Test
  def whenASingleElementListIsPassed_ThenItMatchesTheCorrespondingPattern()
    : Unit = {
  ...
  @Test
  def whenAMultipleElementsListIsPassed_ThenItMatchesTheCorrespondingPattern()
    : Unit = {
    val result = new PatternMatching().sequencesPatternMatching(
      List("Multiple", "Elements")
    )
    assertEquals(
      "I'm a list with one or multiple elements: List(Multiple, Elements)",
      result
    )
  }

  @Test
  def whenAVectorBeginningWithOneAndTwoIsPassed_ThenItMatchesTheCorrespondingPattern()
    : Unit = {
  ...
  @Test
  def whenANotMatchingVectorIsPassed_ThenItShouldntMatchAndEnterTheDefaultClause()
    : Unit = {
  ...
  @Test
  def whenAnEmptyListIsPassed_ThenItShouldntMatchAndEnterTheDefaultClause()
    : Unit = {
  ...
  @Test
  def whenATwoElementsTupleIsPassed_ThenItMatchesTheCorrespondingPattern()
    : Unit = {
    val result =
      new PatternMatching().tuplesPatternMatching(("First", "Second"))
    assertEquals("I'm a tuple with two elements: First & Second", result)
  }

  @Test
  def whenAThreeElementsTupleIsPassed_ThenItMatchesTheCorrespondingPattern()
    : Unit = {
    val result =
      new PatternMatching().tuplesPatternMatching(("First", "Second", "Third"))
    assertEquals(
      "I'm a tuple with three elements: First & Second & Third",
      result
    )
  }

  @Test
  def whenAnoterKindOfTupleIsPassed_ThenItShouldntMatchAndReturnTheDefaultPattern()
    : Unit = {
  ...
  @Test
  def whenAStringConsistingOfNumericsOnlyIsPassed_ThenItShouldMatchTheNumericRegex()
    : Unit = {
  ...
  @Test
  def whenAStringConsistignOfAlphabeticsOnlyIsPassed_ThenItShouldMatchTheAlphabeticRegex()
    : Unit = {
  ...
  @Test
  def whenAStringConsistignOfAlphanumericsOnlyIsPassed_ThenItShouldMatchTheAlphanumericRegex()
    : Unit = {
  ...
  @Test
  def whenAnotherTypeOfStringIsPassed_ThenItShouldntMatchAndReturnTheDefaultPattern()
    : Unit = {
    val result = new PatternMatching().regexPatterns("abc_123")
    assertEquals(
      "I contain other characters than alphanumerics. My value abc_123",
      result
    )
  }
  ...
  @Test
  def whenAListWithAnUnacceptedSizeIsPassed_ThenTheNegativeMessageIsSent()
    : Unit = {
  ...
  @Test
  def whenAStringWithAcceptedSizeIsPassed_ThenThePositiveMessageIsSent()
    : Unit = {
  ...
  @Test
  def whenAStringWithAnUnacceptedSizeIsPassed_ThenTheNegativeMessageIsSent()
    : Unit = {
  ...
  @Test
  def whenAnObjectWhichIsNotAListOrAStringIsPassed_thenTheDefaultClauseIsUsed()
    : Unit = {
  ...
  @Test
  def whenACardSuitIsPassed_ThenTheCorrespondingMatchCaseClauseIsUsed()
    : Unit = {
    ...
    assertEquals(
      "Card is diamond",
      new PatternMatching().sealedClass(Diamond())
    )
  }

  @Test
  def whenAnObjectWithExtractorIsPassed_ThenTheExtractedValueIsUsedInTheCaseClause()
    : Unit = {
  ...
  @Test
  def whenAnObjectWithExtractorIsPassed_AndTheValueIsEmpty_ThenTheDefaultCaseClauseIsUsed()
    : Unit = {
    val person = Person("")
    val result = new PatternMatching().extractors(person)
  ...
  @Test
  def whenAListOfRandomElementsIsPassed_ThenOnlyTheIntegersBelowTenAreReturned()
    : Unit = {
  ...
  def whenAnExceptionIsPassed_ThenTheCorrespondingMessageIsReturned(): Unit = {
    ...
    assertEquals(
      ...
      pm.catchBlocksPatternMatching(iae)
    )
    assertEquals("It's a RuntimeException", pm.catchBlocksPatternMatching(re))
    assertEquals(
      "It's an unknown kind of exception",
      pm.catchBlocksPatternMatching(fnfe)
    )
  }
  ...
  @Test
  def whenBinderPatternWithPartMatchCaseWithoutMatch_ThenReturnMessage()
    : Unit = {
