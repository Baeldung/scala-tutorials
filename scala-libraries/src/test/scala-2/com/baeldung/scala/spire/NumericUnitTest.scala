...
class NumericUnitTest extends AnyFlatSpec with Matchers {
  "sum" should "return the correct sum for a list of integers" in {
  ...
  "sum" should "return the correct sum for a list of doubles" in {
  ...
  "sum" should "return the correct sum for a list of BigDecimals" in {
    val bigDecimalList = List(BigDecimal(1.2), BigDecimal(2.3), BigDecimal(3.4), BigDecimal(4.5))
    val expectedSum = BigDecimal(11.4)

    sum(bigDecimalList) should be(expectedSum)
  }

  "sum" should "return the correct sum for a list of Rationals" in {
