...
/** Type class that instructs implementing types to be able to be formatted as
  * strings.
  *
  * @tparam A
  *   type that needs to implement the trait
  */
trait Printable[A] {

  /** Any type A that implements this trait must be able to present itself as a
    * string.
    *
    * @param value
    *   instance of type [[A]] that implements the type class
    * @return
...
/** Provides implementations of the [[Printable]] type class for types
  * [[String]] and [[Int]].
  */
object Printable {
