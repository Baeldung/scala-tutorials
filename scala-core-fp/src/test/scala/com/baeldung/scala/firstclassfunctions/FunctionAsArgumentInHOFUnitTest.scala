...
class FunctionAsArgumentInHOFUnitTest extends AnyFlatSpec with Matchers {
  "HigherOrderFunction" should "take a function as argument to calculate square" in {
    val squareCalculated = FunctionAsArgumentInHOF.calcAnything(
      2,
      FunctionAsArgumentInHOF.calcSquare
    )
  ...
  "HigherOrderFunction" should "take a function as argument to calculate cube" in {
    val cubeCalculated =
      FunctionAsArgumentInHOF.calcAnything(3, FunctionAsArgumentInHOF.calcCube)
