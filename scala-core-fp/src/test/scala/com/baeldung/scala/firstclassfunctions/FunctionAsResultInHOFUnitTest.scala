...
class FunctionAsResultInHOFUnitTest extends AnyFlatSpec with Matchers {
  "HigherOrderFunction" should "return a function as result to perform addition" in {
    val additionResult =
      FunctionAsResultInHOF.performArithmeticOperation(2, 4, "addition")
  ...
  "HigherOrderFunction" should "return a function as result to perform subtraction" in {
    val subtractionResult =
      FunctionAsResultInHOF.performArithmeticOperation(10, 6, "subtraction")
  ...
  "HigherOrderFunction" should "return a function as result to perform multiplication" in {
    val multiplicationResult =
      FunctionAsResultInHOF.performArithmeticOperation(8, 5, "multiplication")
